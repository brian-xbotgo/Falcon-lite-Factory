...
ifeq ($(BR2_PACKAGE_RKIPC_RV1126B_DUAL_IPC), y)
    RKIPC_DEPENDENCIES += rockit rockchip-rga iva camera-engine-rkaiq freetype
    RKIPC_CONF_OPTS += -DCOMPILE_FOR_RV1126B_DUAL_IPC=ON
    RKIPC_CONF_OPTS += -DRK_APP_ARCH_TYPE=$(RKIPC_ARCH)
    RKIPC_CONF_OPTS += -DCOMPILE_FOR_BUILDROOT=ON
endif
