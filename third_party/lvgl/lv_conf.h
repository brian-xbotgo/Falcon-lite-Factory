...
#define LV_COLOR_CHROMA_KEY lv_color_hex(0x00000000)
...
#define LV_MEM_SIZE (1024U * 1024U * 10U)          /*[bytes]*/
...
#define LV_STDLIB_INCLUDE <stdlib.h>  // 包含 malloc/free/realloc
#define LV_STDIO_INCLUDE  <stdio.h>   // 包含 snprintf
#define LV_STRING_INCLUDE <string.h>  // 包含 memcpy/memset/strlen/strncpy
...
#define LV_FS_POSIX_PATH "/oem/usr/conf/lvgl_source/"         /*Set the working directory. File/directory paths will be appended to it.*/
